...
namespace EmployeesRegister.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        //        .Where(i => i.Department == "Sport").ToList();

        //    return View(model);
        //}

        // GET: Employees/Department
        public ActionResult Department(string searchTerm = null)
        {
            var model = db.Employees
                .Where(i => searchTerm == null || i.Department.StartsWith(searchTerm)).ToList();
        ...
        public ActionResult Position(string searchTerm = null)
        {
            var model = db.Employees
                .Where(i => searchTerm == null || i.Position.StartsWith(searchTerm)).ToList();
